...
class CustomUser(AbstractUser):
    ...
    residence_city = models.CharField(max_length=100, default="")
    phone_customer = models.IntegerField(default=0)
    hair_type = models.CharField(max_length=100, choices=HAIR_TYPES, default=HAIR_TYPE_STRAIGHT)

    GENDER_TYPE_FEMALE = "F"
    GENDER_TYPE_MALE = "M"
    GENDER_TYPES = ((GENDER_TYPE_MALE, "M"), (GENDER_TYPE_FEMALE, "F"))
    gender = models.CharField(max_length=1, choices=GENDER_TYPES, default=GENDER_TYPE_FEMALE)
