"""
Django settings for BeCute project.
...
SECRET_KEY = '==^62e4tma0cw$oic^j4u8sgl4_ysx7%b7vq73k0+i)zt08^am'
...
WSGI_APPLICATION = 'BeCute.wsgi.application'
